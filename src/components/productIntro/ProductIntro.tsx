...
const ProductIntro: React.FC<PropsType> = ({ title, shortDescription, price, coupons, discount, rating, pictures }) => {
  const tableDataSource: RowType[] = [
    ...
    },
    {
      key: 2,
      title: '領取優惠',
      description: coupons ? discount : '無優惠卷可領',
    },
    {
      key: 2,
      title: '線路評價',
  ...
  return (
    <div className={styles['intro-container']}>
      ...
      <Table<RowType> columns={columns} dataSource={tableDataSource} size='small' bordered={false} pagination={false} showHeader={false} />
    </div>
  );
};
